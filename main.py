...
for dataset in sample_datasets:
    ...
    img_rec_l1 = image_reconstructor.image_rec_from_events_l1(events_torch)
    img_rec_l2 = image_reconstructor.image_rec_from_events_l2(events_torch)
    img_rec_denoiser = image_reconstructor.image_rec_from_events_cnn(events_torch)
    # Save images
...
image_reconstructor = ImageReconstructor(flow_torch)
img_rec_l1 = image_reconstructor.image_rec_from_iwe_l1(iwe_torch)
img_rec_l2 = image_reconstructor.image_rec_from_iwe_l2(iwe_torch)
img_rec_denoiser = image_reconstructor.image_rec_from_iwe_cnn(iwe_torch)
# Save images
save_path = os.path.join(output_path, dataset)
save_image(img_rec_l1, save_path, "l1.png")
save_image(img_rec_l2, save_path, "l2.png")
